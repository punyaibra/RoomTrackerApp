...
public class SliderRoomAdapter extends RecyclerView.Adapter<SliderRoomAdapter.ViewHolder> {
    ...
    public SliderRoomAdapter(List<Room> rooms, OnRoomClickListener listener) {
        this.rooms = rooms;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Use the new Slider Layout
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_room_card_slider, parent, false);
